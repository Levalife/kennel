...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Puppies.mother_titles'
        db.add_column(u'puppies_puppies', 'mother_titles',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Puppies.father_titles'
        db.add_column(u'puppies_puppies', 'father_titles',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Puppies.mother_titles'
        db.delete_column(u'puppies_puppies', 'mother_titles')

        # Deleting field 'Puppies.father_titles'
        db.delete_column(u'puppies_puppies', 'father_titles')
