...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dog.sex'
        db.alter_column(u'dogs_dog', 'sex_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['dogs.Gender']))

    def backwards(self, orm):

        # Changing field 'Dog.sex'
        db.alter_column(u'dogs_dog', 'sex_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dogs.Gender'], null=True))
    ...
    models = {
        u'dogs.dog': {
            ...
            'sex': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dogs.Gender']", 'blank': 'True'}),
