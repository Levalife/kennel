...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dog.sex'
        db.add_column(u'dogs_dog', 'sex',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dogs.Gender'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dog.sex'
        db.delete_column(u'dogs_dog', 'sex_id')
    ...
    models = {
        u'dogs.dog': {
            ...
            'sex': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dogs.Gender']", 'null': 'True'}),
