...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offspring.about_dog'
        db.alter_column(u'offsprings_offspring', 'about_dog', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Offspring.about_dog'
        db.alter_column(u'offsprings_offspring', 'about_dog', self.gf('django.db.models.fields.CharField')(max_length=400))
