...
DATABASES = {
    'default': {
        ...
        'NAME': 'kennel',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'postgres',
        'PASSWORD': 'cnhtkmxer17',
...
MEDIA_ROOT = 'c:/Python27/myprojects/kennel/static_content/static/'
...
STATIC_ROOT = 'c:/Python27/myprojects/kennel/static_content/'
...
STATICFILES_DIRS = (
    'c:/Python27/myprojects/kennel/static_content/static/',
...
SECRET_KEY = 'f0=kt(v0-e81#f=$2(+h499^d-(3&97z9r^*w^hc9qrgk5!jez'
...
TEMPLATE_DIRS = (
    'c:/Python27/myprojects/kennel/templates'
